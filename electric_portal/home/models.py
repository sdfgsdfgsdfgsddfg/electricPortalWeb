...
class Assay(models.Model):
    ...
    pdf_file_name       = models.CharField(max_length=100)
...
class Object(models.Model):
    ...
    def updateImage(self, *args, **kwargs):
        ...
        limg2.thumbnail((300,200))
        try:limg3 = Image.open('/home/assays/electricPortalWeb/electric_portal/static/img/seal.jpg')
